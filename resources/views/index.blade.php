    ...
    <div class="sap_tabs">
        <div class="container">
            ...
            <div style="margin-bottom: 10px; display: flex; justify-content: center; align-items:center;">
                ...
                <img src="{{ asset('lapangan/lapanganbasket1.png') }}" class="img-responsive" style="width: 500px; height:300px;" alt="error" />
            ...
            <div style="margin-bottom: 10px; display: flex; justify-content: center; align-items:center;">
                ...
                <img src="{{ asset('lapangan/lapanganbasket2.jpeg') }}" class="img-responsive" style="width: 500px; height:300px;" alt="" />
