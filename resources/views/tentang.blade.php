    ...
    <div class="sap_tabs">
        <div class="container">
            ...
            <div style="display: flex; justify-content: center; align-items:center;">
                ...
                <img src="{{ asset('assets2/images/gambartentang1.jpeg') }}" class="img-responsive" style="width: 400px; height:300px;" alt="" />
                <img src="{{ asset('assets2/images/gambartentang2.jpeg') }}" class="img-responsive" style="width: 400px; height:300px;" alt="" />
                <img src="{{ asset('assets2/images/gambartentang3.jpg') }}" class="img-responsive" style="width: 400px; height:300px;" alt="" />
